...
object GrowingioApiSpec extends App {
  ...
  println("========================segments============================")
  val segments = growingioApi.segments()
  println(segments)
  println("========================tags============================")
  val tags = growingioApi.tags()
  println(tags)
}