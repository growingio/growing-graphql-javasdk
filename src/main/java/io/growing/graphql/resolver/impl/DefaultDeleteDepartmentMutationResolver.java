...
final public class DefaultDeleteDepartmentMutationResolver implements DeleteDepartmentMutationResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultDeleteDepartmentMutationResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultDeleteDepartmentMutationResolver() {}
