...
final public class $DeleteFrequencyAnalysisMutationResolver implements DeleteFrequencyAnalysisMutationResolver {

    private GrowingIOConfig growingIOConfig;

    public $DeleteFrequencyAnalysisMutationResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private $DeleteFrequencyAnalysisMutationResolver() {}

    @javax.validation.constraints.NotNull
    @Override
    public Boolean deleteFrequencyAnalysis(String projectId, String id) throws Exception {
