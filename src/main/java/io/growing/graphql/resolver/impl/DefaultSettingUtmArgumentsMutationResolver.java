...
final public class DefaultSettingUtmArgumentsMutationResolver implements SettingUtmArgumentsMutationResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultSettingUtmArgumentsMutationResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultSettingUtmArgumentsMutationResolver() {}
