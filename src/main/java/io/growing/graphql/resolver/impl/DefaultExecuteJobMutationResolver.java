...
final public class DefaultExecuteJobMutationResolver implements ExecuteJobMutationResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultExecuteJobMutationResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultExecuteJobMutationResolver() {}
