...
final public class DefaultBatchDeleteTunnelsMutationResolver implements BatchDeleteTunnelsMutationResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultBatchDeleteTunnelsMutationResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultBatchDeleteTunnelsMutationResolver() {}
