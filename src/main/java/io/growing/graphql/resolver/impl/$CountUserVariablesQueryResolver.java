...
final public class $CountUserVariablesQueryResolver implements CountUserVariablesQueryResolver {

    private GrowingIOConfig growingIOConfig;

    public $CountUserVariablesQueryResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private $CountUserVariablesQueryResolver() {}

    @Override
    public Integer countUserVariables(String projectId) throws Exception {
