...
final public class DefaultDashboardQueryResolver implements DashboardQueryResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultDashboardQueryResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultDashboardQueryResolver() {}

    @Override
    public DashboardDto dashboard(String id) throws Exception {
