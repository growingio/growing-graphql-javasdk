...
final public class $DeleteDashboardCommentMutationResolver implements DeleteDashboardCommentMutationResolver {

    private GrowingIOConfig growingIOConfig;

    public $DeleteDashboardCommentMutationResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private $DeleteDashboardCommentMutationResolver() {}

    @javax.validation.constraints.NotNull
    @Override
    public Boolean deleteDashboardComment(String projectId, String id) throws Exception {
