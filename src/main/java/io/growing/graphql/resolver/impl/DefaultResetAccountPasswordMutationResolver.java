...
final public class DefaultResetAccountPasswordMutationResolver implements ResetAccountPasswordMutationResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultResetAccountPasswordMutationResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultResetAccountPasswordMutationResolver() {}
