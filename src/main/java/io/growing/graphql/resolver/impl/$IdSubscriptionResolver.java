...
final public class $IdSubscriptionResolver implements IdSubscriptionResolver {

    private GrowingIOConfig growingIOConfig;

    public $IdSubscriptionResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private $IdSubscriptionResolver() {}
