...
final public class $UpdateTunnelMutationResolver implements UpdateTunnelMutationResolver {

    private GrowingIOConfig growingIOConfig;

    public $UpdateTunnelMutationResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private $UpdateTunnelMutationResolver() {}
