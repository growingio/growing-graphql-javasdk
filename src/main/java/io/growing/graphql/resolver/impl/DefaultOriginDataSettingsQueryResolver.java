...
final public class DefaultOriginDataSettingsQueryResolver implements OriginDataSettingsQueryResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultOriginDataSettingsQueryResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultOriginDataSettingsQueryResolver() {}
