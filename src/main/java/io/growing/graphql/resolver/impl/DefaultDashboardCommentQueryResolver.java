...
final public class DefaultDashboardCommentQueryResolver implements DashboardCommentQueryResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultDashboardCommentQueryResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultDashboardCommentQueryResolver() {}

    @Override
    public DashboardCommentDto dashboardComment(String id) throws Exception {
