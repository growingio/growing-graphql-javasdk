...
final public class $VersionQueryResolver implements VersionQueryResolver {

    private GrowingIOConfig growingIOConfig;

    public $VersionQueryResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private $VersionQueryResolver() {}
