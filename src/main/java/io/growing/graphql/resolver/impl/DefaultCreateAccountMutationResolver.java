...
final public class DefaultCreateAccountMutationResolver implements CreateAccountMutationResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultCreateAccountMutationResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultCreateAccountMutationResolver() {}
