...
final public class $CountKpiAnalysesQueryResolver implements CountKpiAnalysesQueryResolver {

    private GrowingIOConfig growingIOConfig;

    public $CountKpiAnalysesQueryResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private $CountKpiAnalysesQueryResolver() {}

    @Override
    public Integer countKpiAnalyses(String projectId) throws Exception {
