...
final public class DefaultSyncUbaUserVariableMutationResolver implements SyncUbaUserVariableMutationResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultSyncUbaUserVariableMutationResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultSyncUbaUserVariableMutationResolver() {}
