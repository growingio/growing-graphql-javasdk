...
final public class DefaultUserProfileQueryResolver implements UserProfileQueryResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultUserProfileQueryResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultUserProfileQueryResolver() {}

    @Override
    public UserProfileDto userProfile(String userId, java.util.List<String> tags, java.util.List<String> properties) throws Exception {
