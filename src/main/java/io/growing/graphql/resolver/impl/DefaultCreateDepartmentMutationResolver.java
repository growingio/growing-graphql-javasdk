...
final public class DefaultCreateDepartmentMutationResolver implements CreateDepartmentMutationResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultCreateDepartmentMutationResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultCreateDepartmentMutationResolver() {}
