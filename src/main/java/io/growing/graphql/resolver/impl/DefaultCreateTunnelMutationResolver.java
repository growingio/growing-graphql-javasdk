...
final public class DefaultCreateTunnelMutationResolver implements CreateTunnelMutationResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultCreateTunnelMutationResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultCreateTunnelMutationResolver() {}
