...
final public class DefaultBatchDeleteKpiAnalysesMutationResolver implements BatchDeleteKpiAnalysesMutationResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultBatchDeleteKpiAnalysesMutationResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultBatchDeleteKpiAnalysesMutationResolver() {}

    @Override
    public Boolean batchDeleteKpiAnalyses(java.util.List<String> ids) throws Exception {
