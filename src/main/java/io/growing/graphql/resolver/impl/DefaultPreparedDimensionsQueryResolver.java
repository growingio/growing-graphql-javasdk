...
final public class DefaultPreparedDimensionsQueryResolver implements PreparedDimensionsQueryResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultPreparedDimensionsQueryResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultPreparedDimensionsQueryResolver() {}

    @Override
    public java.util.List<PreparedDimensionDto> preparedDimensions() throws Exception {
