...
final public class DefaultUpdateDepartmentMutationResolver implements UpdateDepartmentMutationResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultUpdateDepartmentMutationResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultUpdateDepartmentMutationResolver() {}
