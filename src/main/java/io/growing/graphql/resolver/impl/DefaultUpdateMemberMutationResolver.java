...
final public class DefaultUpdateMemberMutationResolver implements UpdateMemberMutationResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultUpdateMemberMutationResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultUpdateMemberMutationResolver() {}
