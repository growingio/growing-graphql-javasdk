...
final public class DefaultCreateMemberMutationResolver implements CreateMemberMutationResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultCreateMemberMutationResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultCreateMemberMutationResolver() {}
