...
final public class DefaultTunnelQueryResolver implements TunnelQueryResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultTunnelQueryResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultTunnelQueryResolver() {}
