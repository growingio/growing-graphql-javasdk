...
final public class DefaultUtmArgumentsQueryResolver implements UtmArgumentsQueryResolver {

    private GrowingIOConfig growingIOConfig;

    public DefaultUtmArgumentsQueryResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private DefaultUtmArgumentsQueryResolver() {}
