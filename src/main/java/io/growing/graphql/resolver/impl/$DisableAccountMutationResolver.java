...
final public class $DisableAccountMutationResolver implements DisableAccountMutationResolver {

    private GrowingIOConfig growingIOConfig;

    public $DisableAccountMutationResolver(GrowingIOConfig growingIOConfig) {
        this.growingIOConfig = growingIOConfig;
    }

    private $DisableAccountMutationResolver() {}
