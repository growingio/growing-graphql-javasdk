...
public class UpdateSegmentMutationRequest implements GraphQLOperationRequest {
    ...
    public UpdateSegmentMutationRequest() {
    }
    ...
    public static class Builder {
        ...
        public UpdateSegmentMutationRequest build() {
            UpdateSegmentMutationRequest obj = new UpdateSegmentMutationRequest();
            obj.setId(id);
