...
public class MutationDeleteKpiAnalysisParametrizedInput implements GraphQLParametrizedInput {
    ...
    public MutationDeleteKpiAnalysisParametrizedInput(String projectId, String id) {
        this.projectId = projectId;
        this.id = id;
    }

    public MutationDeleteKpiAnalysisParametrizedInput projectId(String projectId) {
        this.projectId = projectId;
        return this;
    }
