...
public class UpdateEventVariableMutationRequest implements GraphQLOperationRequest {
    ...
    public UpdateEventVariableMutationRequest() {
    }
    ...
    public static class Builder {
        ...
        public UpdateEventVariableMutationRequest build() {
            UpdateEventVariableMutationRequest obj = new UpdateEventVariableMutationRequest();
            obj.setId(id);
