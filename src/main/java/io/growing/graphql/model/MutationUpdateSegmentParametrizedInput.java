...
public class MutationUpdateSegmentParametrizedInput implements GraphQLParametrizedInput {
    ...
    public MutationUpdateSegmentParametrizedInput(String projectId, String id, SegmentInputDto segment) {
        this.projectId = projectId;
        this.id = id;
        this.segment = segment;
    }

    public MutationUpdateSegmentParametrizedInput projectId(String projectId) {
        this.projectId = projectId;
        return this;
    }
