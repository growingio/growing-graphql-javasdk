...
public class MutationDeleteDashboardCommentParametrizedInput implements GraphQLParametrizedInput {
    ...
    public MutationDeleteDashboardCommentParametrizedInput(String projectId, String id) {
        this.projectId = projectId;
        this.id = id;
    }

    public MutationDeleteDashboardCommentParametrizedInput projectId(String projectId) {
        this.projectId = projectId;
        return this;
    }
