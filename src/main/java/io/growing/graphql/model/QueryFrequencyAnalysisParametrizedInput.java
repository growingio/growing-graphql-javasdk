...
public class QueryFrequencyAnalysisParametrizedInput implements GraphQLParametrizedInput {
    ...
    public QueryFrequencyAnalysisParametrizedInput(String projectId, String id, String dashboardId) {
        this.projectId = projectId;
        this.id = id;
        this.dashboardId = dashboardId;
    }

    public QueryFrequencyAnalysisParametrizedInput projectId(String projectId) {
        this.projectId = projectId;
        return this;
    }
