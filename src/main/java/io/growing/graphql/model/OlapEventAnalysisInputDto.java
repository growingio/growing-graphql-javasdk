...
public class OlapEventAnalysisInputDto implements java.io.Serializable {
    ...
    public OlapEventAnalysisInputDto(String name, String description, java.util.List<MetricInputDto> metrics, java.util.List<String> dimensions, java.util.List<GranularityInputDto> granularities, String timeRange, TargetUserInputDto targetUser, SplitterInputDto splitter, FilterInputDto filter, java.lang.Object attrs, Integer limit, java.util.List<OrderInputDto> orders, String chartType) {
        this.name = name;
    ...
    public static OlapEventAnalysisInputDto.Builder builder() {
        return new OlapEventAnalysisInputDto.Builder();
    }
    ...
    public static class Builder {
        ...
        public OlapEventAnalysisInputDto build() {
            return new OlapEventAnalysisInputDto(name, description, metrics, dimensions, granularities, timeRange, targetUser, splitter, filter, attrs, limit, orders, chartType);
        }
