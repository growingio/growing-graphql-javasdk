...
public class NoticeInfoInputDto implements java.io.Serializable {
    ...
    public NoticeInfoInputDto(String type, java.util.List<String> receivers) {
        this.type = type;
    ...
    public static NoticeInfoInputDto.Builder builder() {
        return new NoticeInfoInputDto.Builder();
    }
    ...
    public static class Builder {
        ...
        public NoticeInfoInputDto build() {
            return new NoticeInfoInputDto(type, receivers);
        }
