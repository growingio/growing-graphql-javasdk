...
public class ValueTypeInputDto implements java.io.Serializable {
    ...
    public ValueTypeInputDto() {
    }

    public ValueTypeInputDto(PrimitiveTypeDto type, ValueUnitDto unit, Boolean isArray) {
        this.type = type;
        this.unit = unit;
    ...
    public static ValueTypeInputDto.Builder builder() {
        return new ValueTypeInputDto.Builder();
    }
    ...
    public static class Builder {
        ...
        public ValueTypeInputDto build() {
            return new ValueTypeInputDto(type, unit, isArray);
        }
