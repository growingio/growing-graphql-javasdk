...
public class TagUserExportJobDto implements java.io.Serializable, JobEntityDto {
    ...
    public TagUserExportJobDto() {
    }

    public TagUserExportJobDto(String id, String name, String description, JobStageDto stage, String creatorId, java.time.ZonedDateTime createdAt, String updaterId, java.time.ZonedDateTime updatedAt, String creator, String updater, ErrorDto error) {
        this.id = id;
        this.name = name;
    ...
    public static TagUserExportJobDto.Builder builder() {
        return new TagUserExportJobDto.Builder();
    }
    ...
    public static class Builder {
        ...
        public TagUserExportJobDto build() {
            return new TagUserExportJobDto(id, name, description, stage, creatorId, createdAt, updaterId, updatedAt, creator, updater, error);
        }
