...
public class RoleDto implements java.io.Serializable {
    ...
    public RoleDto(String id, String name, String description, java.util.List<MemberDto> members, java.util.List<PermissionDto> permissions, Boolean isSystem, Boolean isRoot, Boolean isTechSupport) {
        this.id = id;
        this.name = name;
    ...
    public static class Builder {
        ...
        public RoleDto build() {
            return new RoleDto(id, name, description, members, permissions, isSystem, isRoot, isTechSupport);
        }
