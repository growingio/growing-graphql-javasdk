...
public class GranularityDto implements java.io.Serializable {
    ...
    public GranularityDto() {
    }

    public GranularityDto(String id, java.util.List<String> values, java.lang.Long interval, Double split, java.util.List<String> statistics, java.util.List<Double> ranges, Integer top, String period, Boolean trend) {
        this.id = id;
        this.values = values;
    ...
    public static GranularityDto.Builder builder() {
        return new GranularityDto.Builder();
    }
    ...
    public static class Builder {
        ...
        public GranularityDto build() {
            return new GranularityDto(id, values, interval, split, statistics, ranges, top, period, trend);
        }
