...
public class MutationBatchDeleteEventAnalysesParametrizedInput implements GraphQLParametrizedInput {
    ...
    public MutationBatchDeleteEventAnalysesParametrizedInput(String projectId, java.util.List<String> ids) {
        this.projectId = projectId;
        this.ids = ids;
    }

    public MutationBatchDeleteEventAnalysesParametrizedInput projectId(String projectId) {
        this.projectId = projectId;
        return this;
    }
