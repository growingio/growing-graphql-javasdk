...
public class BatchDeleteDataCenterCustomEventsMutationRequest implements GraphQLOperationRequest {
    ...
    public BatchDeleteDataCenterCustomEventsMutationRequest() {
    }
    ...
    public static class Builder {
        ...
        public BatchDeleteDataCenterCustomEventsMutationRequest build() {
            BatchDeleteDataCenterCustomEventsMutationRequest obj = new BatchDeleteDataCenterCustomEventsMutationRequest();
            obj.setIds(ids);
            return obj;
        }
