...
public class UpdateAnalysisAlertMutationRequest implements GraphQLOperationRequest {
    ...
    public UpdateAnalysisAlertMutationRequest() {
    }
    ...
    public static class Builder {
        ...
        public UpdateAnalysisAlertMutationRequest build() {
            UpdateAnalysisAlertMutationRequest obj = new UpdateAnalysisAlertMutationRequest();
