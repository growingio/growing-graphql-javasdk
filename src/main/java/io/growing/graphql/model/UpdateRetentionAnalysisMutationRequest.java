...
public class UpdateRetentionAnalysisMutationRequest implements GraphQLOperationRequest {
    ...
    public UpdateRetentionAnalysisMutationRequest() {
    }
    ...
    public static class Builder {
        ...
        public UpdateRetentionAnalysisMutationRequest build() {
            UpdateRetentionAnalysisMutationRequest obj = new UpdateRetentionAnalysisMutationRequest();
